...
int headerr()
{
		cout<<"                            HARSH RAI OPERATING SYSTEM                    ";
cout<<"\n";
cout<<"\n";
cout<<"\n===============================================================================";
cout<<"\n";
...
//==============================================================================
  class Bank {
	...
	headerr();
             ...
             gotoxy(31,1); std::cout<<" HARSH RAI BANK INC.";
	...
	headerr();
        ...
        void progressBarGraphicz(){
        		system("cls");
	headerr();
             gotoxy(27,5); std::cout<<"HARSH RAI BANK INCORPORATED";
	...
	headerr();
            ...
            gotoxy(4,6); std::cout<<" HARSH RAI BANK INC. WAZ STARTED IN 2017 IN HONOUR OF THE ";
            ...
            gotoxy(4,9); std::cout<<" A BANK PROJECT AND NAMED IT HARSH RAI BANK INCORPORATED. HARSH RAI";
            ...
            gotoxy(4,12); std::cout<<"HARSH RAI BANK INC IS A   PRIVATLEY OWNED SOFTWARE AND ITS NOT";
            gotoxy(4,13); std::cout<<" AFFILIATED TO ANY BANK. HARSH RAI BANK IS SITUATED IN HINDALCO COLONY ";
            gotoxy(4,14); std::cout<<"BUT SOON GOING GLOBAL. HARSH RAI BANK INC IS FUNDED BY MARK ZUKERBERG ";
            ...
            gotoxy(32,19); std::cout<<". OUTLAW TILL I DROP!! - HARSH RAI ";
            gotoxy(32,20); std::cout<<"NOTIFICATION ";
...
//==============================================================================
   void balanceCheck(){
	...
	headerr();
        ...
        gotoxy(18,17);std::cout<<" WITH HARSH RAI BANK INCORPORATED!!";
        getch();
  ...
  void bankerMenu(){
	...
	headerr();
       ...
       do {
           ...
           gotoxy(32,3); std::cout<<"HARSH RAI BANK INC.";
...
//==============================================================================
   void bankerLogin(void){
	...
	headerr();        
        ...
        gotoxy(30,5); std::cout<<"HARSH RAI BANK INC.";
...
//==============================================================================
 ...
 {	system("cls");
	headerr();
      ...
      gotoxy(30,5); std::cout<<"HARSH RAI BANK INC.";
      gotoxy(26,11); std::cout<<"PROGRAMMER: HARSH RAI";
